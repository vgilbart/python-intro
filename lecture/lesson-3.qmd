...
```{bash}
conda init # Run just once after installing conda, to actually start working in conda
...
Add images ![alt text](https://jupyter.org/assets/homepage/main-logo.svg){width=10%}: `![alt text](https://jupyter.org/assets/homepage/main-logo.svg){width=10%}`
