...
Python will assign a type automatically to any numerical value given. In the example above, variable `weight_kg` has an integer value of `60`.
...
The output of `print(weight_kg, weight_lb, ...)`, with a specific parameter instead of the `...` should look like this:
...
Filter the data to keep only the patients that have an average inflammation across days strcitly greater than 6.
